...
元素指標是指向陣列第一個元素的指標。
當你寫 `int *ptr = arr;`，代表 ptr 指向 `arr[0]`，也就是陣列的第一個元素。
...
// 初始化函數指針
pointer_name = &function_name; // 寫法01：使用 & 取函數位址
pointer_name = function_name;  // 寫法02：函數名稱本身隱含位址，& 可省略
...
![upgit_20250319_1742372900.png|666x333](https://raw.githubusercontent.com/kcwc1029/obsidian-upgit-image/main/2025/03/upgit_20250319_1742372900.png)
