...
### 14.3. [將指標作為回傳值](./Pointer/using_pointer_as_return.c)

### 14.4. [雙重指標](./Pointer/double_pointer.c)

-   指標是指向資料型態
-   雙重指標是指向目標的指標

### 14.5. [指標運算](./Pointer/pointer_arithmetic.c)

### 14.6. [指標常數與陣列](.//Pointer/pointer_constants_arrays.c)
...
#### 17.2.3. strncpy、strncat 第三個參數(處理緩衝區覆蓋，但要手動'\0')
...
## 26. C 語言的命令列參數（Command Line Arguments）
